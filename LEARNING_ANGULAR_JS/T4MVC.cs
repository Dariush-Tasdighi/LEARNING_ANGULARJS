...
{
	public static LEARNING_ANGULAR_JS.Controllers.FileUploadController FileUpload = new LEARNING_ANGULAR_JS.Controllers.T4MVC_FileUploadController();
	public static LEARNING_ANGULAR_JS.Controllers.GetRuntimeTemplateController GetRuntimeTemplate = new LEARNING_ANGULAR_JS.Controllers.T4MVC_GetRuntimeTemplateController();
	public static LEARNING_ANGULAR_JS.Controllers.HomeController Home = new LEARNING_ANGULAR_JS.Controllers.T4MVC_HomeController();
	public static LEARNING_ANGULAR_JS.Controllers.IwpcoController Iwpco = new LEARNING_ANGULAR_JS.Controllers.T4MVC_IwpcoController();
	public static LEARNING_ANGULAR_JS.Controllers.LearningDirectiveController LearningDirective = new LEARNING_ANGULAR_JS.Controllers.T4MVC_LearningDirectiveController();
	public static LEARNING_ANGULAR_JS.Controllers.LearningSpaController LearningSpa = new LEARNING_ANGULAR_JS.Controllers.T4MVC_LearningSpaController();
	public static LEARNING_ANGULAR_JS.Controllers.LearningValidationController LearningValidation = new LEARNING_ANGULAR_JS.Controllers.T4MVC_LearningValidationController();
	public static LEARNING_ANGULAR_JS.Controllers.MapnaController Mapna = new LEARNING_ANGULAR_JS.Controllers.T4MVC_MapnaController();
	public static LEARNING_ANGULAR_JS.Controllers.PersonController Person = new LEARNING_ANGULAR_JS.Controllers.T4MVC_PersonController();
}
...
namespace Links
{
	...
	public static class Scripts {
    	...
    	public static class angular_ui {
    		public const string UrlPath = "~/Scripts/angular-ui";
    		public static string Url() { return T4MVCHelpers.ProcessVirtualPath(UrlPath); }
    		public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(UrlPath + "/" + fileName); }
    	...
    	public static readonly string FileAPI_flash_swf = Url("FileAPI.flash.swf");
    	public static readonly string FileAPI_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(UrlPath + "/FileAPI.min.js") ? Url("FileAPI.min.js") : Url("FileAPI.js");
    	public static readonly string FileAPI_min_js = Url("FileAPI.min.js");
    	[GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    	...
    	public static readonly string ng_file_upload_all_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(UrlPath + "/ng-file-upload-all.min.js") ? Url("ng-file-upload-all.min.js") : Url("ng-file-upload-all.js");
    	public static readonly string ng_file_upload_all_min_js = Url("ng-file-upload-all.min.js");
    	public static readonly string ng_file_upload_shim_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(UrlPath + "/ng-file-upload-shim.min.js") ? Url("ng-file-upload-shim.min.js") : Url("ng-file-upload-shim.js");
    	public static readonly string ng_file_upload_shim_min_js = Url("ng-file-upload-shim.min.js");
    	public static readonly string ng_file_upload_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(UrlPath + "/ng-file-upload.min.js") ? Url("ng-file-upload.min.js") : Url("ng-file-upload.js");
    	public static readonly string ng_file_upload_min_js = Url("ng-file-upload.min.js");
    	[GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    ...
    public static partial class Bundles
    {
        public static partial class Scripts 
        {
            ...
            public static class Assets
            {
                ...
                public const string FileAPI_js = "~/Scripts/FileAPI.js"; 
                public const string FileAPI_min_js = "~/Scripts/FileAPI.min.js"; 
                ...
                public const string ng_file_upload_all_js = "~/Scripts/ng-file-upload-all.js"; 
                public const string ng_file_upload_all_min_js = "~/Scripts/ng-file-upload-all.min.js"; 
                public const string ng_file_upload_shim_js = "~/Scripts/ng-file-upload-shim.js"; 
                public const string ng_file_upload_shim_min_js = "~/Scripts/ng-file-upload-shim.min.js"; 
                public const string ng_file_upload_js = "~/Scripts/ng-file-upload.js"; 
                public const string ng_file_upload_min_js = "~/Scripts/ng-file-upload.min.js"; 
            }
        }
